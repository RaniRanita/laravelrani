...
<div class="alert alert-success alert-dismisssible fade show">
...
<div class="alert alert-success alert-dismisssible fade show">
	<strong>dDelete!</strong> Berhasil dihapus.
	<button type="button" class="close" data-dismiss="alert" > &times;
	</button>
</div>
@endif
...
<div class="alert alert-denger alert-dismisssible fade show">
...
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog">
	<div class="modal-dialog" role="document">
		...
		<div class="modal-footer">
			...
			<button class="btn-primary btn-delete" type="button
			">Delete</button>
		</div>
