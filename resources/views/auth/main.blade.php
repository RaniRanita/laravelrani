...
<html lang="en">
  ...
  <head>
    ...
    <title>Ranita - @yield('title')</title>

    <!-- Bootstrap core CSS-->
    <link href="{{url('sbadminrani1/vendor/bootstrap/css/bootstrap.min.css')}}" rel="stylesheet">

    <!-- Custom fonts for this template-->
    <link href="{{url('sbadminrani1/vendor/fontawesome-free/css/all.min.css')}}" rel="stylesheet" type="text/css">
  ...
  <body class="bg-dark">
    ...
    <script src="{{url('sbadminrani1/vendor/jquery-easing/jquery.easing.min.js')}}"></script>
